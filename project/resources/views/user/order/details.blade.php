                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @endif
                                        {{$order->method}} {{ $langg->lang296 }} <p id="ttn">{{$order->txnid}}</p><a
                                            id="tid" style="cursor: pointer;">{{ $langg->lang297 }}</a> <a
                                ...
                                <table class="table table-bordered veiw-details-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$product['size']}}</td>
                                            <td><span
                                                    style="width: 40px; height: 20px; display: block; border: 10px solid {{$product['color'] == "" ? "white" : $product['color']}};"></span>
                                            </td>
