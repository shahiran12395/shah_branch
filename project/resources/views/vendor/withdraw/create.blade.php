                        ...
                        <div class="content-area">
                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-sm-4" for="name"><b>{{ $langg->lang498 }}{{ App\Models\Product::vendorConvertPrice( App\Models\VendorOrder::where('user_id','=',Auth::user()->id)->where('status','=','completed')->sum('price') ) }}</b></label>
                                </div>
