                        ...
                        <div class="list">
                            <ul>
                                        ...
                                        <div class="my-dropdown-menu profile-dropdown">
                                            <ul class="profile-links">
                                                ...
                                                @if(Auth::user()->IsSupplier())
                                                    <li>
                                                        <a href="{{ route('supplier-dashboard') }}"><i
                                                                    class="fas fa-angle-double-right"></i> {{ $langg->supplierlang4 }}
                                                        </a>
                                                    </li>
                                                @endif
                                ...
                                @if($gs->reg_vendor == 1)
                                    <li>
                                        @if(Auth::check())
                                            ...
                                            @elseif(Auth::guard('web')->user()->is_supplier == 1)
                                ...
                                @else
                                    ...
                                    {{--<li>--}}
                                        {{--<a href="javascript:;" data-toggle="modal" data-target="#supplier-login"--}}
                                           {{--class="sell-btn">{{ $langg->supplierlang1 }}</a>--}}
                                    {{--</li>--}}
                                @endif
                                @endif
                            ...
                            <div class="login-form signup-form">
                                ...
                                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label>Please Tick one</label>
                                        </div>
                                        <div class="col-lg-4">
                                            <input type="radio" name="is_supplier"
                                                   id="is_vendor" {{ old('is_supplier') ? 'checked' : '' }} value="0" checked>
                                            <label for="is_supplier">{{ $langg->lang530 }}</label>
                                        </div>

                                        <div class="col-lg-4">
                                            <input type="radio" name="is_supplier"
                                                   id="is_supplier" {{ old('is_supplier') ? 'checked' : '' }} value="1">
                                            <label for="is_supplier">{{ $langg->supplierlang4 }}</label>
                                        </div>
...
{{--<div class="modal fade" id="supplier-login" tabindex="-1" role="dialog" aria-labelledby="supplier-login-Title"--}}
     {{--aria-hidden="true">--}}
    {{--<div class="modal-dialog  modal-dialog-centered" style="transition: .5s;" role="document">--}}
        {{--<div class="modal-content">--}}
            {{--<div class="modal-header">--}}
            ...
            {{--<div class="modal-body">--}}
                {{--<nav class="comment-log-reg-tabmenu">--}}
                    {{--<div class="nav nav-tabs" id="nav-tab1" role="tablist">--}}
                        {{--<a class="nav-item nav-link login active" id="nav-log-tab11" data-toggle="tab" href="#nav-log111"--}}
                           {{--role="tab" aria-controls="nav-log" aria-selected="true">--}}
                            {{--{{ $langg->supplierlang2 }}--}}
                        {{--</a>--}}
                        {{--<a class="nav-item nav-link" id="nav-reg-tab11" data-toggle="tab" href="#nav-reg111" role="tab"--}}
                           {{--aria-controls="nav-reg" aria-selected="false">--}}
                            {{--{{ $langg->supplierlang3 }}--}}
                        {{--</a>--}}
                    {{--</div>--}}
                {{--</nav>--}}
                {{--<div class="tab-content" id="nav-tabContent">--}}
                    {{--<div class="tab-pane fade show active" id="nav-log111" role="tabpanel" aria-labelledby="nav-log-tab">--}}
                        {{--<div class="login-area">--}}
                            {{--<div class="login-form signin-form">--}}
                                {{--@include('includes.admin.form-login')--}}
                                {{--<form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">--}}
                                    ...
                                    {{--<div class="form-forgot-pass">--}}
                                        {{--<div class="left">--}}
                                            {{--<input type="checkbox" name="remember"--}}
                                                   {{--id="mrp2" {{ old('remember') ? 'checked' : '' }}>--}}
                                            {{--<label for="mrp2">{{ $langg->lang175 }}</label>--}}
                                        {{--</div>--}}
                                        {{--<div class="right">--}}
                                            {{--<a href="javascript:;" id="show-forgot2">--}}
                                                {{--{{ $langg->lang176 }}--}}
                                            {{--</a>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                        ...
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="tab-pane fade" id="nav-reg111" role="tabpanel" aria-labelledby="nav-reg-tab">--}}
                        {{--<div class="login-area signup-area">--}}
                            {{--<div class="login-form signup-form">--}}
                                {{--@include('includes.admin.form-login')--}}
                                {{--<form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">--}}
