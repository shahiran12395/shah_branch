                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="nav flex-column" role="tablist"
                                                            ...
                                                            @if($gs->paypal_check == 1)
                                                                <a class="nav-link payment active" data-show="no"
                                                            ...
                                                            @endif
                                                            @if($gs->billplz_check == 1)
                                                                @if($digital == 0)
                                                                    <a class="nav-link payment" data-show="no"
                                                                       data-form="{{route('billplz.submit')}}"
                                                                       data-href="{{ route('front.load.payment',['slug1' => 'billplz','slug2' => 0]) }}"
                                                            ...
                                                            @if($digital == 0)
                                                                ...
                                                                @foreach($gateways as $gt)
                                                                    ...
                                                                    <a class="nav-link payment" data-show="yes"
                                                                       ...
                                                                       data-toggle="pill" href="#v-pills-tab5"
                                                                       role="tab"
