...
@section('styles')
    ...
    <link href="{{asset('assets/supplier/css/product.css')}}" rel="stylesheet"/>
...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ $langg->lang629 }}
                        <a class="add-btn" href="{{ route('supplier-prod-types') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a>
                    </h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('supplier-dashboard') }}">{{ $langg->lang441 }}</a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ $langg->lang444 }} </a>
                        </li>
                        <li>
                            <a href="{{ route('supplier-prod-index') }}">{{ $langg->lang446 }}</a>
                        </li>
                        <li>
                            <a href="{{ route('supplier-prod-types') }}">{{ $langg->lang445 }}</a>
                        </li>
                        <li>
                            <a href="{{ route('supplier-prod-physical-create') }}">{{ $langg->lang629 }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('supplier-prod-store')}}" method="POST"
                                  enctype="multipart/form-data">
                                {{csrf_field()}}

                                @include('includes.supplier.form-both')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select id="cat" name="category_id" required="">
                                            ...
                                            @foreach($cats as $cat)
                                                <option data-href="{{ route('supplier-subcat-load',$cat->id) }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <input type="number" name="whole_sell_qty[]"
                                                                       class="input-field"
                                                                       placeholder="{{ $langg->lang661 }}" min="0">
                                                            </div>

                                                            <div class="col-lg-6">
                                                                <input type="number" name="whole_sell_discount[]"
                                                                       class="input-field"
                                                                       placeholder="{{ $langg->lang662 }}" min="0"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
