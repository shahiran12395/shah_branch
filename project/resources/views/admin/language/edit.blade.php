 ...
 {{-- VENDOR PANEL STARTS --}}
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang534" placeholder="Invoice Number" required="" value="{{ $lang->lang534 }}">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang557" placeholder="Name" required="" value="{{ $lang->lang557 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang595" placeholder="Quantity" required="" value="{{ $lang->lang595 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang596" placeholder="Line Total" required="" value="{{ $lang->lang596 }}">
                          </div>
                        </div>
