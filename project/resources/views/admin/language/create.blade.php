...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Language') }} <a class="add-btn"
                                                                    href="{{route('admin-lang-index')}}"><i
                                        ...
                                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang16"
                                                               placeholder="Track Order" required=""
                                                               value="Track Order">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang11"
                                                               placeholder="My Account" required=""
                                                               value="My Account">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang221"
                                                               placeholder="User Panel" required=""
                                                               value="User Panel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang1"
                                                               placeholder="All Categories" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang5"
                                                               placeholder="View Cart" required=""
                                                               value="View Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang8"
                                                               placeholder="Cart is empty." required=""
                                                               value="Cart is empty.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang15"
                                                               placeholder="See All Categories" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang27"
                                                               placeholder="Best Seller" required=""
                                                               value="Best Seller">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang244"
                                                               placeholder="Flash Deal" required=""
                                                               value="Flash Deal">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang28"
                                                               placeholder="Top Rated" required=""
                                                               value="Top Rated">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang34"
                                                               placeholder="Read More" required=""
                                                               value="Read More">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang236"
                                                               placeholder="Our Partners" required=""
                                                               value="Our Partners">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang43"
                                                               placeholder="Recent Post" required=""
                                                               value="Recent Post">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang53"
                                                               placeholder="Find Us Here" required=""
                                                               value="Find Us Here">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang55"
                                                               placeholder="Quick View" required=""
                                                               value="Quick View">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang56"
                                                               placeholder="Add To Cart" required=""
                                                               value="Add To Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang62"
                                                               placeholder="To" required="" value="To">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang63"
                                                               placeholder="Popular Tags" required=""
                                                               value="Popular Tags">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang65"
                                                               placeholder="Latest Product" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang66"
                                                               placeholder="Oldest Product" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang67"
                                                               placeholder="Lowest Price" required=""
                                                               value="Lowest Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang68"
                                                               placeholder="Highest Price" required=""
                                                               value="Highest Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang70"
                                                               placeholder="Product Compare" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang81"
                                                               placeholder="Contact Seller" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang84"
                                                               placeholder="License Type" required=""
                                                               value="License Type">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang219"
                                                               placeholder="Watch Video" required=""
                                                               value="Watch Video">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang102"
                                                               placeholder="To Review" required=""
                                                               value="To Review">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang103"
                                                               placeholder="To Comment" required=""
                                                               value="To Comment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang105"
                                                               placeholder="Write Your Comments Here..." required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang248"
                                                               placeholder="Total Item" required=""
                                                               value="Total Item">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang249"
                                                               placeholder="Visit Store" required=""
                                                               value="Visit Store">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang768"
                                                               placeholder="Buy More, Save More!" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang769"
                                                               placeholder="Additional Discount" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang776"
                                                               placeholder="Report This Item" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang777"
                                                               placeholder="REPORT PRODUCT" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang778"
                                                               ...
                                                               required="" value="Please give the following details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang780"
                                                               placeholder="Enter Report Note" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang123"
                                                               placeholder="Size & Color" required=""
                                                               value="Size & Color">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang127"
                                                               placeholder="PRICE DETAILS " required=""
                                                               value="PRICE DETAILS">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang128"
                                                               placeholder="Total MRP " required=""
                                                               value="Total MRP">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang160"
                                                               placeholder="Ship to a Different Address?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang162"
                                                               placeholder="Order Now" required=""
                                                               value="Order Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang758"
                                                               placeholder="Shipping Info" required=""
                                                               value="Shipping Info">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang759"
                                                               placeholder="Payment Info" required=""
                                                               value="Payment Info">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang760"
                                                               placeholder="PayPal Express" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang763"
                                                               placeholder="Instamojo" required=""
                                                               value="Instamojo">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang781"
                                                               placeholder="Card number not valid" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang782"
                                                               placeholder="CVC number not valid" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang168"
                                                               placeholder="Wishlists" required=""
                                                               value="Wishlists">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang172"
                                                               placeholder="LOGIN NOW" required=""
                                                               value="LOGIN NOW">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang234"
                                                               placeholder="Vendor Login" required=""
                                                               value="Vendor Login">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang179"
                                                               placeholder="Or" required="" value="Or">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang181"
                                                               placeholder="Signup Now" required=""
                                                               value="Signup Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang227"
                                                               placeholder="Service Center" required=""
                                                               value="Store Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang228"
                                                               placeholder="Contact Now" required=""
                                                               value="Contact Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang21"
                                                               placeholder="Footer Links" required=""
                                                               value="Footer Links">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                               placeholder="Wishlist Remove Message"
                                                               name="wish_remove"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                               placeholder="Compare Remove Message"
                                                               name="compare_remove"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                               ...
                                                               value="Oops Something Goes Wrong !!" required="">
                                                    </div>
                                                </div>
                            ...
                            <textarea name="order_text"
                                      required="">We'll email you an order confirmation with details and tracking info.</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                               ...
                                                               value="You have subscribed successfully." required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                               placeholder="Subscribe Error Message"
                                                               name="subscribe_error"
                                                               value="This email has already been taken." required="">
                                                    </div>
                                                </div>
                                      ...
                                      required="">The page you are looking for might have been moved, renamed, or might never existed.</textarea>
                                            ...
                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang230"
                                                               placeholder="Vendor Panel" required=""
                                                               value="Vendor Panel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang205"
                                                               placeholder="Edit Profile" required=""
                                                               value="Edit Profile">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang206"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang207"
                                                               placeholder="Logout" required=""
                                                               value="Logout">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang233"
                                                               placeholder="Start Selling" required=""
                                                               value="Start Selling">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang237"
                                                               placeholder="Pricing Plans" required=""
                                                               value="Pricing Plans">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang208"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang209"
                                                               placeholder="Email" required=""
                                                               value="Email">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang210"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang211"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang212"
                                                               placeholder="City" required=""
                                                               value="City">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang213"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang214"
                                                               placeholder="Address" required=""
                                                               value="Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang281"
                                                               placeholder="Order Status" required=""
                                                               value="Order Status">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang283"
                                                               placeholder="VIEW ORDER" required=""
                                                               value="VIEW ORDER">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang286"
                                                               placeholder="print order" required=""
                                                               value="print order">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang295"
                                                               placeholder="Charge ID:" required=""
                                                               value="Charge ID:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">Enter Transaction ID & Press Enter
                                                                *</h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang317"
                                                               placeholder="View License" required=""
                                                               value="View License">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang327"
                                                               placeholder="Affiliate Banner HTML Code *" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang329"
                                                               placeholder="My Withdraws" required=""
                                                               value="My Withdraws">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang330"
                                                               placeholder="Withdraw Now" required=""
                                                               value="Withdraw Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang331"
                                                               placeholder="Withdraw Date" required=""
                                                               value="Withdraw Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang351"
                                                               placeholder="Withdraw Fee" required=""
                                                               value="Withdraw Fee">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang257"
                                                               placeholder="Confirm Delete" required=""
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">You are about to delete this
                                                                Conversation. *</h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang377"
                                                               placeholder="Add Ticket" required=""
                                                               value="Add Ticket">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang379"
                                                               placeholder="Add Dispute" required=""
                                                               value="Add Dispute">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang404"
                                                               placeholder="Current Plan" required=""
                                                               value="Current Plan">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang405"
                                                               placeholder="Expired on:" required=""
                                                               value="Expired on:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang436"
                                                               placeholder="New Order(s)." required=""
                                                               value="New Order(s).">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang437"
                                                               placeholder="Clear All" required=""
                                                               value="Clear All">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang443"
                                                               placeholder="All Orders" required=""
                                                               value="All Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang451"
                                                               placeholder="Withdraws" required=""
                                                               value="Withdraws">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang456"
                                                               placeholder="Social Links" required=""
                                                               value="Social Links">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang463"
                                                               placeholder="Shop Details" required=""
                                                               value="Shop Details">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang536"
                                                           placeholder="Total Cost" required=""
                                                           value="Total Cost">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang541"
                                                           placeholder="Processing" required=""
                                                           value="Processing">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang542"
                                                           placeholder="Completed" required=""
                                                           value="Completed">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="left-area">
                                                        <h4 class="heading">You are about to update the Order's Status.
                                                            *</h4>
                                                        <p class="sub-heading">(In Any Language)</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang554"
                                                           placeholder="Ordered Date" required=""
                                                           value="Ordered Date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang555"
                                                           placeholder="View Invoice" required=""
                                                           value="View Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang556"
                                                           placeholder="Billing Details" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang566"
                                                           placeholder="Products Ordered" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang575"
                                                           placeholder="Vendor Removed" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang576"
                                                           placeholder="Send Email" required=""
                                                           value="Send Email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang585"
                                                           placeholder="Save License" required=""
                                                           value="Save License">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang586"
                                                           placeholder="Order Invoice" required=""
                                                           value="Order Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="left-area">
                                                        <h4 class="heading">Line Total *</h4>
                                                        <p class="sub-heading">(In Any Language)</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang596"
                                                           placeholder="Line Total" required=""
                                                           value="Line Total">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang599"
                                                           placeholder="TAX" required="" value="TAX">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang602"
                                                           placeholder="Shipping Method" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang607"
                                                           placeholder="Print Invoice" required=""
                                                           value="Print Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang713"
                                                           placeholder="Activated" required=""
                                                           value="Activated">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang714"
                                                           placeholder="Deactivated" required=""
                                                           value="Deactivated">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang716"
                                                           placeholder="View Gallery" required=""
                                                           value="View Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang619"
                                                           placeholder="Image Gallery" required=""
                                                           value="Image Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang624"
                                                           placeholder="No Images Found." required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang625"
                                                           placeholder="Product Types" required=""
                                                           value="Product Types">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang629"
                                                           placeholder="Physical Product" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang630"
                                                           placeholder="Digital Product" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang631"
                                                           placeholder="License Product" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang635"
                                                           placeholder="New" required="" value="New">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang640"
                                                           placeholder="Child Category" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang645"
                                                           placeholder="Set Gallery" required=""
                                                           value="Set Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang646"
                                                           placeholder="Allow Estimated Shipping Time" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang655"
                                                           placeholder="Add More Size" required=""
                                                           value="Add More Size">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang657"
                                                           placeholder="Product Colors" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang658"
                                                           placeholder="(Choose Your Favorite Colors)" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang659"
                                                           placeholder="Add More Color" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang663"
                                                           placeholder="Add More Field" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang665"
                                                           placeholder="In" required="" value="In">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang684"
                                                           placeholder="Meta Tags" required=""
                                                           value="Meta Tags">
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang686"
                                                           placeholder="Feature Tags" required=""
                                                           value="Feature Tags">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang690"
                                                           placeholder="Create Product" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang693"
                                                           placeholder="Upload By File" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang694"
                                                           placeholder="Upload By Link" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang697"
                                                           placeholder="Product License" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang699"
                                                           placeholder="License Quantity" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang701"
                                                           placeholder="Product Platform" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang702"
                                                           placeholder="Product Region" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang704"
                                                           placeholder="Edit Product" required=""
                                                           value="Edit Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang533"
                                                           placeholder="Start Import" required=""
                                                           value="Start Import">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang481"
                                                           placeholder="Withdraw Method" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang495"
                                                           placeholder="and" required="" value="and">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang500"
                                                           placeholder="Featured Image" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang515"
                                                           placeholder="Create Service" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang719"
                                                           placeholder="Shipping Methods" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang721"
                                                           placeholder="Packagings" required=""
                                                           value="Packagings">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang520"
                                                           placeholder="Current Banner" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang522"
                                                           placeholder="Upload Banner" required=""
                                                           value="Upload Banner">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang527"
                                                           placeholder="Google Plus" required=""
                                                           value="Google Plus">
                                                </div>
                                            </div>
